    ...
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                ...
                <a href="faculty.php" class="list-group-item text-center teacher_det active">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
          <div class="bhoechie-tab-content active">
            <div class="row">
              ...
              <!-- start of faculty details section -->
              <div class="container-fluid faculty_list">
                <table class="table table-striped table-responsive table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>Dr.Suresh Joseph</td>
                      <td>R.V Nagar Kalapet</td>
                      <td>8903451256</td>
                      <td>ksureshpu@gmail.com</td>
                      <td>Phd</td>
                      <td>Data mining</td>
                      <td>8 Years</td>
                      <td>s_profile.jpg</td>
              ...
              <!-- end of faculty details section -->
