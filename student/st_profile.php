...
<!-- end of top nav section -->
  ...
  <body>
    ...
    <?php 
        ...
        $pf_query = "SELECT * FROM `aes_student` WHERE `aes_student`.`email_id` = '$session_id'";
          ...
          <div class="row">
           ...
           <div class="row">
             ...
             <div class="col-sm-6 col-md-6 col-lg-6 men_reg">
              <div class="pf_image">
                <img src="../img/<?php echo $pf_det['image'] ?>" alt="Profile Image">
              </div>
               <div class="btn_pannel" >
                    ...
                    <div class="tab-pane fade" id="select">
                     <form action="act_stpf.php" method="post" name="student_pf" id="student_pf" enctype="multipart/form-data">
                       <div class="form-group"> 
                          <label for="alumni_id"><h5>Student Id :*</h5></label>
                          <input type="text" name="student_id" id="student_id" class="form-control" value="<?php echo $pf_det['student_id'] ?>">
                       </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                         <label for="passing_year"><h5>Academic Year : *</h5></label>
                         <input type="text" name="academic_year" id="academic_year" class="form-control" value="<?php echo $pf_det['academic_year'] ?>">
                       </div>
                       <div class="form-group">
                         <label for="job_descp"><h5>Address : *</h5></label>
                       </div>
                       <div class="text-area">
                         <textarea name="address" id="address" cols="30" rows="10" class="form-control"><?php echo $pf_det['address'] ?></textarea>
                       </div>
                       <br>
                       <div class="form-group">
                        <span>
                      ...
                      <div class="form-group">
                       ...
                       <div class="btn_pannel">
                         <input type="submit" class="men_save" value="Submit" name="btn_update" id="btn_update">
                       </div>
                     </form>
                    </div>
                </div>
