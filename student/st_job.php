           ...
           <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
              ...
              <div class="post_panel">
                <input type="submit" value="Post New Job" disabled="" data-toggle="tab" href="#select1" class="post_job">
                <div class="tab-pane fade" id="select1">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="job_title" id="job_title" required="" maxlength="100" placeholder="Add Job Title" class="form-control" value="Software Engineer">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="btn_panel">
                    <input type="submit" value="Submit" class="sav_btn_job">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 al_job_search">
              <div class="search_panel">
                ...
                <form action="">
                  <div class="form-group">
                    <input type="text" placeholder="Job Title...." class="form-control" id="search_tag">
                    <input type="submit" class="job_sea_button" value="Search" data-toggle="tab" href="#select">
                  </div>
                </form>
                  ...
                  <div class="ser_result">
                    <div class="row">
                      ...
                      <div class="col-xs-8 job_descp">
                        <h4 style="text-transform: uppercase;color: #7F0909;">Java Developer</h4>
                        <p>
                           making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words,
                         <a href="#" class="btn btn-primary btn-xs apply">Apply</a>
                        </p>
                        <i class="fa fa-clock-o" style="color: #558CBD; font-size: 15px;">&nbsp;Last Date: 12 March 2018</i>
                      </div>
                    </div>
                    <hr>
                  </div>
